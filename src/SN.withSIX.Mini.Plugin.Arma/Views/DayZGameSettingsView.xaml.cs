// <copyright company="SIX Networks GmbH" file="DayZGameSettingsView.xaml.cs">
...
{
    /// <summary>
    ///     Interaction logic for DayZGameSettingsView.xaml
    /// </summary>
    public partial class DayZGameSettingsView : UserControl, IDayZGameSettingsView
    {
        public static readonly DependencyProperty ViewModelProperty =
            DependencyProperty.Register("ViewModel", typeof (IDayZGameSettingsViewModel),
                typeof (DayZGameSettingsView),
                new PropertyMetadata(null));

        public DayZGameSettingsView() {
            InitializeComponent();
        ...
        public IDayZGameSettingsViewModel ViewModel
        {
            get { return (IDayZGameSettingsViewModel) GetValue(ViewModelProperty); }
            set { SetValue(ViewModelProperty, value); }
        }
        object IViewFor.ViewModel
        {
            get { return ViewModel; }
            set { ViewModel = (IDayZGameSettingsViewModel) value; }
        }
    }

    public interface IDayZGameSettingsView : IViewFor<IDayZGameSettingsViewModel> {}
}