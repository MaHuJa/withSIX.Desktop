// <copyright company="SIX Networks GmbH" file="Arma3StartupParameters.cs">
...
{
    [DataContract]
    public class Arma3StartupParameters : ArmaStartupParameters
    {
    ...
    [DataContract]
    public abstract class ArmaStartupParameters : RealVirtualityStartupParameters
    {
        string[] _identities;
        protected ArmaStartupParameters(params string[] defaultParameters) : base(defaultParameters) {}
