// <copyright company="SIX Networks GmbH" file="WindowsAPIErrorCodes.cs">
...
namespace SN.withSIX.Core.Helpers
{
    ...
    /// </summary>
    public class WindowsAPIExcpetion : Exception
    {
        public WindowsAPIExcpetion(Int32 errorCode)
            : base(WindowsAPIErrorCodes.ToString(errorCode)) {
            ErrorCode = errorCode;
        }

        public WindowsAPIExcpetion(Int32 errorCode, string message)
            : base(message) {
            ErrorCode = errorCode;
        }

        public WindowsAPIExcpetion(Int32 errorCode, Exception innerException)
            : base(WindowsAPIErrorCodes.ToString(errorCode), innerException) {
            ErrorCode = errorCode;
        }

        public WindowsAPIExcpetion(Int32 errorCode, string message, Exception innerException)
    ...
    /// <summary>
    ///     Contains all Windows API Error codes from 0-499
    /// </summary>
    public static class WindowsAPIErrorCodes
    {
        ...
        public const Int32 ERROR_ELEVATION_REQUIRED = 740;
